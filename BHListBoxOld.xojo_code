...
Implements BHControl
	...
	#tag Event
		Sub CellTextChange(row as Integer, column as Integer)
		  RaiseEvent CellTextChange(row, column)
		End Sub
	#tag EndEvent
	...
	#tag Method, Flags = &h0
		Sub Cell(pRow As Integer, pColumn As Integer, Assigns pValue As String)
		  Super.Cell(pRow, pColumn) = pValue
		  
		  RaiseEvent CellTextChange(pRow, pColumn)
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Sub RemoveRowFrom(pFrom As Integer)
		  For pRow As Integer = pFrom To Me.ListCount - 1
		    Me.RemoveRow(pRow)
		  Next
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Sub RemoveRowTo(pTo As Integer)
		  For pRow As Integer = 0 To pTo
		    Me.RemoveRow(pRow)
		  Next
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Sub Row(pRow As Integer, Assigns pValues() As String)
		  Me.Row(pRow, pValues)
		End Sub
	#tag EndMethod
